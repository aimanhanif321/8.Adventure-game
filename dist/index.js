    ...
    const chooseWest = await inquirer.prompt([
        {
            name: "stop",
            type: "list",
            message: chalk.bgWhite.black.bold("Monster HP is 20\n what to want to do"),
            choices: ["Run", "Attack"],
        },
    ]);
    if (chooseWest === "Run") {
        ...
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.black.bold(`You Attack the Monster and gave 10 damage`));
        console.log(chalk.bgWhite.bold.black(`Monster HP:10 `));
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.black.bold(`Monster Attack you and gave 2 damage`));
...
async function handelGateSituation() {
    ...
    if (question3.situation === "1.talk to the guard") {
        ...
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.black.bold(`Guard : Hey Don't be stupid...\n The Guard hit you so hard.`));
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.black.bold(`you gave up !`));
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.black.bold(` you recevie 3 damage Now your HP is: ${(energy -= 3)} `));
        console.log(chalk.yellowBright(`===============================================================`));
        await continueOrexit();
    }
        ...
        let question4 = await inquirer.prompt([
            {
                name: "leave",
                type: "list",
                message: chalk.bgWhite.blackBright.bold("you are at the cross road\nif you choose south you reached the gate of the town."),
                choices: [
                    "Go south",
                    "Go north",
                    "Go east",
        ...
        if (question4.leave === "Go south") {
            ...
            console.log(chalk.yellowBright(`===============================================================`));
            console.log(chalk.bgWhite.blackBright.bold(`There is a river\nYou drink the water and rest the rive side`));
            console.log(chalk.bgWhite.blackBright.bold(`(Your HP is recover by 2 now your HP is: ${(energy += 2)})`));
            console.log(chalk.yellowBright(`===============================================================`));
            await handelGateSituation();
        }
...
async function fightAgain() {
    ...
    if (againFight.again === true) {
        ...
        await fighting();
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.blackBright.bold(`You deafeat the monster !\n monster dropped the Ring`));
...
async function winner() {
    ...
    if (enterinTown.winner === true) {
        console.log(chalk.yellowBright(`===============================================================`));
        console.log(chalk.bgWhite.bold.black(`guard Realized you have a silver ! \n oh you defeat the gobblin now you Enter in town`));
        console.log(chalk.yellowBright(`===============================================================`));
    }
    else {
